...
import '../helperClasses/advice_helper_class.dart';
...
class AdviceScreen extends StatefulWidget {
  ...
  @override
  State<AdviceScreen> createState() => AdviceScreenState();
}
      ...
      body: TransformerPageView(
        ...
        itemBuilder: (context, index) {
          return LayoutStackForData(
            imgUrl: Activity.activityBgImgUrl,
            quote: Activity.activity,
            author: Activity.activityGenre,
          );
        },
      ),
    );
