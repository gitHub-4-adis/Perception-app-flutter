...
import '../helperClasses/number_facts_helper_class.dart';
...
class NumberFactsScreen extends StatefulWidget {
  ...
  @override
  State<NumberFactsScreen> createState() => NumberFactsScreenState();
}

class NumberFactsScreenState extends State<NumberFactsScreen> {
      ...
      body: TransformerPageView(
        ...
        itemBuilder: (context, index) {
          return LayoutStackForData(
            imgUrl: NumberFacts.numberFactsBgImgUrl,
            quote: NumberFacts.numberFact,
            author: NumberFacts.numberFactGenre,
          );
        },
      ),
    );
